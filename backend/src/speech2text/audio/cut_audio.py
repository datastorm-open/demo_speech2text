...
# Couper l'audio en fonction du silence
def cut(input_file,output,silence_thresh = -70 ,min_silence_len = 700 , length_limit = 60 * 1000 , abandon_chunk_len = 500 , joint_silence_len = 1300 ):
    # change mp3 to wav
    input_file = change_type.change.wav(input_file)
...
# cut(
#     input_file="C:/Users/KaichengLi/PycharmProjects/my_project/audio/en_1.mp3",
#     output="C:/Users/KaichengLi/PycharmProjects/my_project/speech2text"
# )
